...
namespace DataImport.Web.Services
{
    public class EdFiServiceV311 : EdFiServiceBase
    {
        ...
        public EdFiServiceV311(DataImportDbContext dbContext, IEncryptionKeyResolver encryptionKeyResolver, ISwaggerMetadataFetcher metadataFetcher, IAuthRequestWrapper oauthRequestWrapper, IOptions<AppSettings> options)
            : base(dbContext)
        {
