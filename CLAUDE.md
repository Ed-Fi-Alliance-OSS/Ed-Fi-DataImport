...
.\build.ps1 run -LaunchProfile mssql # Run web app with SQL Server
.\build.ps1 run -LaunchProfile pg    # Run web app with PostgreSQL
```
...
- **Rijndael256** — encryption for stored credentials
